...
- [Maths](guide/maths.md)
    - [Tensors](guide/preprocessing/tensors.md)
        ...
        - [Einsum](guide/preprocessing/einsum.md)
    ...
    - [Neural Networks](guide/neuralnetworks.md)
        - [Kolmogorov-Arnorld Networks](guide/kan.md)
...
- [Optimizations](guide/optimizations/intro.md)
    - [Normalizations](guide/optimizations/normalize.md)
        ...
        - [Images Normalization](guide/optimizations/imnorm.md)
